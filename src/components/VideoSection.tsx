...
const VideoSection = () => {
  useEffect(() => {
    ...
    script.src =
      "https://scripts.converteai.net/d0d64cb2-dca3-4be6-983c-3bc700b6a1d8/players/698be8f77e645e63cdd4a6ac/v4/player.js";
    script.async = true;
        ...
        player.addEventListener("player:ready", function () {
          ...
          const checkVisibility = setInterval(() => {
            ...
            if (
              !pricingSection ||
              (pricingSection &&
                getComputedStyle(pricingSection).display !== "none")
            ) {
              if (!fullscreenDisabled) {
      ...
      <div className="container mx-auto px-3 sm:px-4 max-w-4xl">
        ...
        >
          ...
          <span className="text-foreground">
            Scientists uncover a natural cure for Memory Loss that can be made at
            home
          </span>
        </motion.h1>
